                    ...
                    <div class="row">
                        <form method="POST" action="{{ route('electronics.filterdAds') }}" class="product-widget-form">
                                        ...
                                        <ul class="product-widget-list">
                                            <li class="product-widget-item">
                                                <div class="product-widget-checkbox"><input type="checkbox" value="12000"
                                                        ...
                                                        name="capacity_12000" class="condition">
                                                </div>
                                                <label class="product-widget-label">
                                                    <span>12000 BTU</span>
                                                </label>
                            ...
                            @if ($id == 11)
                                <div class="col-md-6 col-lg-12">
                                    <div class="product-widget">
                                        <h6 class="product-widget-title">Filter by Screen Size</h6>
                                        <ul class="product-widget-list">
                                            <li class="product-widget-item">
                                                <div class="product-widget-checkbox"><input type="checkbox" value="24"
                                                        @if (null !== session('electronics_filter_data.inch_24')) checked @endif name="inch_24"
                                                        class="condition">
                                                </div>
                                                <label class="product-widget-label">
                                                    <span>24 inches</span>
                                            ...
                                            <li class="product-widget-item">
                                                <div class="product-widget-checkbox"> <input type="checkbox"
                                                        ...
                                                        class="condition" name="inch_other">
                                                </div>
                                                <label class="product-widget-label">
                                                    <span>other</span>
                                                </label>
                                    ...
                                    <ul class="product-widget-list">
                                        ...
                                        <li class="product-widget-item">
                                            <div class="product-widget-checkbox"> <input type="checkbox"
                                                    ...
                                                    @if (null !== session('electronics_filter_data.Anuradhapura')) checked @endif>
                                        ...
                                        <li class="product-widget-item">
                                            <div class="product-widget-checkbox"> <input type="checkbox"
                                                    ...
                                                    @if (null !== session('electronics_filter_data.Hambantota')) checked @endif>
                                        ...
                                        <li class="product-widget-item">
                                            <div class="product-widget-checkbox"> <input type="checkbox"
                                                    ...
                                                    @if (null !== session('electronics_filter_data.Kilinochchi')) checked @endif>
                                        ...
                                        <li class="product-widget-item">
                                            <div class="product-widget-checkbox"> <input type="checkbox"
                                                    ...
                                                    @if (null !== session('electronics_filter_data.Kurunegala')) checked @endif>
                                        ...
                                        <li class="product-widget-item">
                                            <div class="product-widget-checkbox"> <input type="checkbox"
                                                    ...
                                                    @if (null !== session('electronics_filter_data.Monaragala')) checked @endif>
                                        ...
                                        <li class="product-widget-item">
                                            <div class="product-widget-checkbox"> <input type="checkbox"
                                                    ...
                                                    @if (null !== session('electronics_filter_data.Mullaitivu')) checked @endif>
                                        ...
                                        <li class="product-widget-item">
                                            <div class="product-widget-checkbox"> <input type="checkbox"
                                                    ...
                                                    @if (null !== session('electronics_filter_data.Nuwara_Eliya')) checked @endif>
                                        ...
                                        <li class="product-widget-item">
                                            <div class="product-widget-checkbox"> <input type="checkbox"
                                                    ...
                                                    @if (null !== session('electronics_filter_data.Polonnaruwa')) checked @endif>
