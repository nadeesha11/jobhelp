                                    ...
                                    <ul class="product-widget-list">
                                        <li class="product-widget-item">
                                            <div class="product-widget-checkbox"><input type="checkbox" value="Ampara"
                                                    ...
                                                    @if (null !== session('education_filter_data.Ampara')) checked @endif>
                                            </div>
                                        ...
                                        <li class="product-widget-item">
                                            <div class="product-widget-checkbox"> <input type="checkbox"
                                                    ...
                                                    id="chcek2" @if (null !== session('education_filter_data.Anuradhapura')) checked @endif>
                                        ...
                                        <li class="product-widget-item">
                                            <div class="product-widget-checkbox"> <input type="checkbox" value="Badulla"
                                                    ...
                                                    @if (null !== session('education_filter_data.Badulla')) checked @endif>
                                        ...
                                        <li class="product-widget-item">
                                            <div class="product-widget-checkbox"> <input type="checkbox" value="Batticaloa"
                                                    ...
                                                    @if (null !== session('education_filter_data.Batticaloa')) checked @endif>
                                        ...
                                        <li class="product-widget-item">
                                            <div class="product-widget-checkbox"> <input type="checkbox" value="Colombo"
                                                    ...
                                                    @if (null !== session('education_filter_data.Colombo')) checked @endif>
                                        ...
                                        <li class="product-widget-item">
                                            <div class="product-widget-checkbox"> <input type="checkbox" value="Galle"
                                                    ...
                                                    @if (null !== session('education_filter_data.Galle')) checked @endif>
                                        ...
                                        <li class="product-widget-item">
                                            <div class="product-widget-checkbox"> <input type="checkbox" value="Gampaha"
                                                    ...
                                                    @if (null !== session('education_filter_data.Gampaha')) checked @endif>
                                        ...
                                        <li class="product-widget-item">
                                            <div class="product-widget-checkbox"> <input type="checkbox" value="Hambantota"
                                                    ...
                                                    @if (null !== session('education_filter_data.Hambantota')) checked @endif>
                                        ...
                                        <li class="product-widget-item">
                                            <div class="product-widget-checkbox"> <input type="checkbox" value="Jaffna"
                                                    ...
                                                    @if (null !== session('education_filter_data.Jaffna')) checked @endif>
                                        ...
                                        <li class="product-widget-item">
                                            <div class="product-widget-checkbox"> <input type="checkbox" value="Kalutara"
                                                    ...
                                                    @if (null !== session('education_filter_data.Kalutara')) checked @endif>
                                        ...
                                        <li class="product-widget-item">
                                            <div class="product-widget-checkbox"> <input type="checkbox" value="Kandy"
                                                    ...
                                                    @if (null !== session('education_filter_data.Kandy')) checked @endif>
                                        ...
                                        <li class="product-widget-item">
                                            <div class="product-widget-checkbox"> <input type="checkbox" value="Kegalle"
                                                    ...
                                                    @if (null !== session('education_filter_data.Kegalle')) checked @endif>
                                        ...
                                        <li class="product-widget-item">
                                            <div class="product-widget-checkbox"> <input type="checkbox"
                                                    ...
                                                    id="chcek2" @if (null !== session('education_filter_data.Kilinochchi')) checked @endif>
                                        ...
                                        <li class="product-widget-item">
                                            <div class="product-widget-checkbox"> <input type="checkbox"
                                                    ...
                                                    id="chcek2" @if (null !== session('education_filter_data.Kurunegala')) checked @endif>
                                        ...
                                        <li class="product-widget-item">
                                            <div class="product-widget-checkbox"> <input type="checkbox" value="Mannar"
                                                    ...
                                                    @if (null !== session('education_filter_data.Mannar')) checked @endif>
                                        ...
                                        <li class="product-widget-item">
                                            <div class="product-widget-checkbox"> <input type="checkbox" value="Matale"
                                                    ...
                                                    @if (null !== session('education_filter_data.Matale')) checked @endif>
                                        ...
                                        <li class="product-widget-item">
                                            <div class="product-widget-checkbox"> <input type="checkbox" value="Matara"
                                                    ...
                                                    @if (null !== session('education_filter_data.Matara')) checked @endif>
                                        ...
                                        <li class="product-widget-item">
                                            <div class="product-widget-checkbox"> <input type="checkbox"
                                                    ...
                                                    id="chcek2" @if (null !== session('education_filter_data.Monaragala')) checked @endif>
                                        ...
                                        <li class="product-widget-item">
                                            <div class="product-widget-checkbox"> <input type="checkbox"
                                                    ...
                                                    id="chcek2" @if (null !== session('education_filter_data.Mullaitivu')) checked @endif>
                                        ...
                                        <li class="product-widget-item">
                                            <div class="product-widget-checkbox"> <input type="checkbox"
                                                    ...
                                                    id="chcek2" @if (null !== session('education_filter_data.Nuwara_Eliya')) checked @endif>
                                        ...
                                        <li class="product-widget-item">
                                            <div class="product-widget-checkbox"> <input type="checkbox"
                                                    ...
                                                    id="chcek2" @if (null !== session('education_filter_data.Polonnaruwa')) checked @endif>
                                        ...
                                        <li class="product-widget-item">
                                            <div class="product-widget-checkbox"> <input type="checkbox" value="Puttalam"
                                                    ...
                                                    @if (null !== session('education_filter_data.Puttalam')) checked @endif>
                                        ...
                                        <li class="product-widget-item">
                                            <div class="product-widget-checkbox"> <input type="checkbox"
                                                    ...
                                                    @if (null !== session('education_filter_data.Ratnapura')) checked @endif>
                                        ...
                                        <li class="product-widget-item">
                                            <div class="product-widget-checkbox"> <input type="checkbox"
                                                    ...
                                                    id="chcek2" @if (null !== session('education_filter_data.Trincomalee')) checked @endif>
                                        ...
                                        <li class="product-widget-item">
                                            <div class="product-widget-checkbox"> <input type="checkbox" value="Vavuniya"
                                                    ...
                                                    @if (null !== session('education_filter_data.Vavuniya')) checked @endif>
                        ...
                        <div class="col-lg-12">
                            <div class="header-filter">
                                <div class="filter-show">
                                    <div class="filter-show">
                                        <a href="{{ route('ads.displaymain.ads', ['id' => $cat_id]) }}">Back to education
                                        </a>
                                    </div>
                                </div>
