    ...
    <aside class="sidebar-part">
        <div class="sidebar-body">
            <div class="sidebar-header">
                <a href="index.html" class="sidebar-logo"><img src="{{ asset('images/logo.png') }}"
                        alt="logo"></a>
                <button class="sidebar-cross"><i class="fas fa-times"></i></button>
            </div>
            <div class="sidebar-content">
                <div class="sidebar-profile">
                    <a href="#" class="sidebar-avatar"><img src="{{ asset('images/avatar/01.jpg') }}"
                            alt="avatar"></a>
                    ...
                    <div class="tab-pane active" id="main-menu">
                        <ul class="navbar-list">
                            ...
                            <li class="navbar-item"><a class="navbar-link"
                                    href="{{ route('web.contactus') }}">Contact us</a></li>
                        </ul>
                    </div>
    ...
    <nav class="mobile-nav">
        <div class="container">
            <div class="mobile-group">
                ...
                <a href="{{ route('web.userForm') }}" class="mobile-widget">
