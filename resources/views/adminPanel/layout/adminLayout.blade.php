...
<head>
    ...
    <link rel="stylesheet"
        href="{{ asset('admin/node_modules/datatables.net-bs4/css/dataTables.bootstrap4.min.css') }}">
    <link rel="stylesheet" href="{{ asset('admin/node_modules/jvectormap/jquery-jvectormap.css') }}">
    <link rel="stylesheet"
        href="{{ asset('admin/node_modules/tempusdominus-bootstrap-4/build/css/tempusdominus-bootstrap-4.min.css') }}">
    ...
    <script>
        window.jQuery || document.write('<script src="{{ asset('admin/src/js/vendor/jquery-3.3.1.min.js') }}"><\/script>')
    </script>
...
<body>
                ...
                <div class="sidebar-content">
                    <div class="nav-container">
                        <nav id="main-menu-navigation" class="navigation-main">
                            ...
                            <div class="nav-item">
                                <a href="{{ route('admin.adminManagement') }}"><i class="ik ik-menu"></i><span>Admin
                                        Management</span></a>
                            </div>

                            <div class="nav-item">
                                <a href="{{ route('admin.category.index') }}"><i
                                        class="ik ik-menu"></i><span>Category (crud)</span></a>
                            </div>

                            <div class="nav-item">
                                <a href="{{ route('admin.packages.index') }}"><i class="ik ik-menu"></i><span>Ad
                                        Types</span></a>
                            </div>

                            <div class="nav-item">
                                <a href="{{ route('admin.ads.management') }}"><i class="ik ik-menu"></i><span>ads
                                        management</span></a>
                            </div>
    ...
    <script src="{{ asset('admin/node_modules/tempusdominus-bootstrap-4/build/js/tempusdominus-bootstrap-4.min.js') }}">
    </script>
