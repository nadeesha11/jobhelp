                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>Negotiable</td>
                                                <td>
                                                    @if ($ads_education->price_negotiable == '1')
                                                        Yes
                                                    @else
                                                        No
                                                    @endif
                                            ...
                                            @if ($ads_subcategory == 28 || $ads_subcategory == 31 || $ads_subcategory == 32)
                                            @else
                                                <tr>
                                                    <th scope="row"></th>
                                                    <td>Type</td>
                                                    <td>{{ $ads_education->sct_name }}</td>
                                                </tr>
                                            @endif
                                            @if ($ads_subcategory == 29)
                                                <tr>
                                                    <th scope="row"></th>
                                                    <td>Condition</td>
                                                    <td>
                                                        @if ($ads_education->edu_condition == 'on')
                                                            New
                                                        @else
                                                            Used
                                                        @endif
